...
/**
 * Content for Fizzi documents
 */
interface PageDocumentData {
  /**
   * Title field in *Fizzi*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
  ...
  /**
   * Meta Description field in *Fizzi*
   *
   * - **Field Type**: Text
